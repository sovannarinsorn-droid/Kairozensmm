...
ADMIN_ID           = int(os.getenv("ADMIN_ID", "0"))       # Telegram ID របស់ Admin

# ── CamRapidPay — Create KHQR + Check transaction ──
CAMRAPID_API_KEY   = os.getenv("CAMRAPID_API_KEY", "")     # CamRapidPay API Key
